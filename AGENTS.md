...
- **Jauge / HelloAsso (hors bundle site) :** procédure, OAuth, règles d’agrégation et script Apps Script de référence dans **docs/slices/helloasso-jauge-sync.md** et **scripts/google-apps-script/helloasso-jauge-sync.gs** (secrets uniquement dans le Sheet / propriétés du script).
