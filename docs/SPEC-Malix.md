...
- Mode photo local et album (consultation, partage via la feuille native du système lorsque le navigateur le supporte, sinon enregistrement local de l’image, et suppression manuelle d’une photo).
